...
(define-module (helm armory temporal)
...
(define-public temporal-0.16.0
  (package
   (name "temporal")
   (version "0.16.0")
   (source (origin
            (method url-fetch)
            (uri "https://armory.jfrog.io/artifactory/charts/temporal-0.16.0.tgz")
            (sha256 #f)))
...
(define-public temporal-0.15.2
  (package
   (name "temporal")
   (version "0.15.2")
   (source (origin
            (method url-fetch)
            (uri "https://armory.jfrog.io/artifactory/charts/temporal-0.15.2.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://temporal.io/")
   (synopsis "Temporal is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way.")
