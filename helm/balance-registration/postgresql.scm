...
(define-module (helm balance-registration postgresql)
...
(define-public postgresql-8.6.4
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/balance-registration/master/api/helm//charts/postgresql-8.6.4.tgz")
            (sha256 #f)))
