...
(define-module (helm checkin-component checkin-component)
...
(define-public checkin-component-0.1.0
  (package
   (name "checkin-component")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/checkin-component/master/api/helm//checkin-component-0.1.0.tgz")
            (sha256 #f)))
