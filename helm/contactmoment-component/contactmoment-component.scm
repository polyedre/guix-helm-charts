...
(define-module (helm contactmoment-component contactmoment-component)
...
(define-public contactmoment-component-0.1.0
  (package
   (name "contactmoment-component")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/ContactMoment-Component/master/api/helm//contactmoment-component-0.1.0.tgz")
            (sha256 #f)))
