...
(define-module (helm devtron-labs argo-workflow)
...
(define-public argo-workflow-0.1.6
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/devtron-labs/charts/gh-pages/argo-workflow-0.1.6.tgz")
            (sha256 #f)))
...
(define-public argo-workflow-0.1.5
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/devtron-labs/charts/gh-pages/argo-workflow-0.1.5.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "")
   (synopsis "Chart to deploy argo-workflow")
