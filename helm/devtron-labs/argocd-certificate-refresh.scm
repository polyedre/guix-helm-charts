...
(define-module (helm devtron-labs argocd-certificate-refresh)
...
(define-public argocd-certificate-refresh-0.10.7
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/devtron-labs/charts/gh-pages/argocd-certificate-refresh-0.10.7.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "")
   (synopsis "Helm chart to deploy argocd certificate refresh CronJob.")
...
(define-public argocd-certificate-refresh-0.10.6
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/devtron-labs/charts/gh-pages/argocd-certificate-refresh-0.10.6.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "")
   (synopsis "Helm chart to deploy argocd certificate refresh CronJob.")
...
(define-public argocd-certificate-refresh-0.10.5
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/devtron-labs/charts/gh-pages/argocd-certificate-refresh-0.10.5.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "")
   (synopsis "Helm chart to deploy argocd certificate refresh CronJob.")
