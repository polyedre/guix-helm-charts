...
(define-module (helm docparser docparser)
...
(define-public docparser-0.1.0
  (package
   (name "docparser")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/docparser/master/api/helm//docparser-0.1.0.tgz")
            (sha256 #f)))
