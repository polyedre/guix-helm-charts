...
(define-module (helm edu metallb)
...
(define-public metallb-0.1.1
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "http://iac-source.github.io/helm-charts/metallb-0.1.1.tgz")
            (sha256 #f)))
...
(define-public metallb-0.1.1
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "http://iac-source.github.io/helm-charts/metallb/metallb-0.1.1.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://github.com/metallb/metallb")
   (synopsis "unofficial helm chart of MetalLB, bare-metal LoadBalancer")
...
(define-public metallb-0.1.0
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "http://iac-source.github.io/helm-charts/metallb-0.1.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://github.com/metallb/metallb")
   (synopsis "unofficial helm chart of MetalLB, bare-metal LoadBalancer")
