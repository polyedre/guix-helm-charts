...
(define-module (helm export-component export-component)
...
(define-public export-component-0.1.0
  (package
   (name "export-component")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/export-component/master/api/helm//export-component-0.1.0.tgz")
            (sha256 #f)))
