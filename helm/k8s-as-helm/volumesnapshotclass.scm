...
(define-module (helm k8s-as-helm volumesnapshotclass)
...
(define-public volumesnapshotclass-1.0.0
  (package
   (name "volumesnapshotclass")
   (version "1.0.0")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/ameijer/k8s-as-helm/releases/download/volumesnapshotclass-1.0.0/volumesnapshotclass-1.0.0.tgz")
            (sha256 #f)))
