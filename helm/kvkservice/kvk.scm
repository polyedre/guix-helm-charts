...
(define-module (helm kvkservice kvk)
...
(define-public kvk-0.1.0
  (package
   (name "kvk")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/kvkservice/master/api/helm//kvk-0.1.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "kvk.zuid-drecht.nl")
