...
(define-module (helm logicmonitor-helm-charts releasemanager)
...
(define-public releasemanager-0.3.0
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://github.com/logicmonitor/helm-charts/releases/download/releasemanager-0.3.0/releasemanager-0.3.0.tgz")
            (sha256 #f)))
