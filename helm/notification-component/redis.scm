...
(define-module (helm notification-component redis)
...
(define-public redis-12.7.7
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/notification-component/master/api/helm//charts/redis-12.7.7.tgz")
            (sha256 #f)))
