...
(define-module (helm nutanix-scratch nutanix-csi-storage)
...
(define-public nutanix-csi-storage-3.0.0-beta.1912
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://github.com/nutanix-scratch/helm/releases/download/nutanix-csi-storage-rc-1/nutanix-csi-storage-3.0.0-beta.1912.tgz")
            (sha256 #f)))
