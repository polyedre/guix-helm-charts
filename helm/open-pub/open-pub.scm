...
(define-module (helm open-pub open-pub)
...
(define-public open-pub-0.1.0
  (package
   (name "open-pub")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/OpenPub/master/wordpress-docker/helm//open-pub-0.1.0.tgz")
            (sha256 #f)))
