...
(define-module (helm openshift ibm-oms-pro-prod)
...
(define-public ibm-oms-pro-prod-6.0.1
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://github.com/IBM/charts/blob/master/repo/ibm-helm/ibm-oms-pro-prod-6.0.1.tgz?raw=true")
            (sha256 #f)))
...
(define-public ibm-oms-pro-prod-6.0.2
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://github.com/IBM/charts/blob/master/repo/ibm-helm/ibm-oms-pro-prod-6.0.2.tgz?raw=true")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "http://ibm.biz/oms-home")
