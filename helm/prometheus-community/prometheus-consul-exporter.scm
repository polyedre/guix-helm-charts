...
(define-module (helm prometheus-community prometheus-consul-exporter)
...
(define-public prometheus-consul-exporter-1.0.0
  (package
   (name "prometheus-consul-exporter")
   (version "1.0.0")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/prometheus-community/helm-charts/releases/download/prometheus-consul-exporter-1.0.0/prometheus-consul-exporter-1.0.0.tgz")
            (sha256 #f)))
...
(define-public prometheus-consul-exporter-0.5.1
  (package
   (name "prometheus-consul-exporter")
   (version "0.5.1")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/prometheus-community/helm-charts/releases/download/prometheus-consul-exporter-0.5.1/prometheus-consul-exporter-0.5.1.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://github.com/prometheus/consul_exporter")
   (synopsis "A Helm chart for the Prometheus Consul Exporter")
...
(define-public prometheus-consul-exporter-0.5.0
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://github.com/prometheus-community/helm-charts/releases/download/prometheus-consul-exporter-0.5.0/prometheus-consul-exporter-0.5.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://github.com/prometheus/consul_exporter")
   (synopsis "A Helm chart for the Prometheus Consul Exporter")
