...
(define-module (helm proto-component-commonground postgresql)
...
(define-public postgresql-10.1.1
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/Proto-component-commonground/master/api/helm//charts/postgresql-10.1.1.tgz")
            (sha256 #f)))
