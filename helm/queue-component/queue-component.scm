...
(define-module (helm queue-component queue-component)
...
(define-public queue-component-0.1.0
  (package
   (name "queue-component")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/queue-component/master/api/helm//queue-component-0.1.0.tgz")
            (sha256 #f)))
