...
(define-module (helm stufservice stufservice)
...
(define-public stufservice-0.1.0
  (package
   (name "stufservice")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/stufservice/master/api/helm//stufservice-0.1.0.tgz")
            (sha256 #f)))
