...
(define-module (helm taalhuizen-service postgresql)
...
(define-public postgresql-10.1.1
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/taalhuizen-service/master/api/helm//charts/postgresql-10.1.1.tgz")
            (sha256 #f)))
