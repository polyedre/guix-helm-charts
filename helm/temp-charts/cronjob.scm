...
(define-module (helm temp-charts cronjob)
...
(define-public cronjob-v0.7.1
  (package
   (name "cronjob")
   (version "v0.7.1")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/cronjob-v0.7.1/cronjob-v0.7.1.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://argonaut.dev")
   (synopsis "Helm chart for cronjob; Argonaut Resource Template (ART)")
   (description "Helm chart for cronjob; Argonaut Resource Template (ART)")
   (license #f)))

(define-public cronjob-v0.7.0
  (package
   (name "cronjob")
   (version "v0.7.0")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/cronjob-v0.7.0/cronjob-v0.7.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://argonaut.dev")
   (synopsis "Helm chart for cronjob; Argonaut Resource Template (ART)")
