...
(define-module (helm temp-charts meilisearch)
...
(define-public meilisearch-v0.7.1
  (package
   (name "meilisearch")
   (version "v0.7.1")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/meilisearch-v0.7.1/meilisearch-v0.7.1.tgz")
            (sha256 #f)))
...
(define-public meilisearch-v0.7.0
  (package
   (name "meilisearch")
   (version "v0.7.0")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/meilisearch-v0.7.0/meilisearch-v0.7.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://github.com/meilisearch/meilisearch-kubernetes/charts")
   (synopsis "A Helm chart for the Meilisearch search engine")
