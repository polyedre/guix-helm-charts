...
(define-module (helm temp-charts stateless)
...
(define-public stateless-v0.7.1
  (package
   (name "stateless")
   (version "v0.7.1")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/stateless-v0.7.1/stateless-v0.7.1.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://argonaut.dev")
   (synopsis "Helm chart for stateless; Argonaut Resource Template (ART)")
   (description "Helm chart for stateless; Argonaut Resource Template (ART)")
   (license #f)))

(define-public stateless-v0.7.0
  (package
   (name "stateless")
   (version "v0.7.0")
   (source (origin
            (method url-fetch)
            (uri "https://github.com/aadhav-argonaut/charts/releases/download/stateless-v0.7.0/stateless-v0.7.0.tgz")
            (sha256 #f)))
   (build-system copy-build-system)
   (home-page "https://argonaut.dev")
   (synopsis "Helm chart for stateless; Argonaut Resource Template (ART)")
