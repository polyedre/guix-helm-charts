...
(define-module (helm verzoekregistratiecomponent postgresql)
...
(define-public postgresql-10.10.3
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/verzoekregistratiecomponent/master/api/helm//charts/postgresql-10.10.3.tgz")
            (sha256 #f)))
