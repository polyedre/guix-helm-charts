...
(define-module (helm vsbe-service vsbe-service)
...
(define-public vsbe-service-0.1.0
  (package
   (name "vsbe-service")
   (version "0.1.0")
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/vsbe-service/master/api/helm//vsbe-service-0.1.0.tgz")
            (sha256 #f)))
