...
(define-module (helm webresourcecatalogus redis)
...
(define-public redis-15.3.2
  (package
   ...
   (source (origin
            (method url-fetch)
            (uri "https://raw.githubusercontent.com/ConductionNL/webresourcecatalogus/master/api/helm//charts/redis-15.3.2.tgz")
            (sha256 #f)))
